# Spec — relatorio-periodico-ses-s3

## Purpose

Relatórios periódicos (FR-11, FR-17, FR-12): Lambda Quarkus distinta da API e do
alerta (`lambda-report`) agrega Avaliações no RDS (read-only), envia e-mail HTML via
