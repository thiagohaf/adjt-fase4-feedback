...
`GET /avaliacao` com `nota`/`urgencia`/`ocorridoEm`/vínculos de catálogo,
...
O sistema SHALL, em `GET /avaliacao`
...
- **WHEN** existem Avaliações persistidas e o Administrador envia `GET /avaliacao`
...
- **WHEN** existem Avaliações do Estudante A e do Estudante B e o cliente envia `GET /avaliacao` com JWT do Estudante A
