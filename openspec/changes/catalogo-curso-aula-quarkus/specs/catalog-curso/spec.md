...
> Deriva de `openspec/modules/02-catalogo-curso-aula/specs.md` (FR-3/FR-4 para Curso:
> SPEC-3.1–3.4, SPEC-4.1–4.3, SPEC-4.8, SPEC-NFR-C*). Cada cenário DEVE virar teste.
